    ...
    return (
        <RightSectionWrapper>
            ...
            <PopularTagsList>
                ...
                <PopularTag>
                    <TopicItem type='gatsby' size='5px' border='3px' fontSize='15px' to={`/tags/gatsby`}>gatsby</TopicItem>
                </PopularTag>
                <PopularTag>
                    <TopicItem type='react' size='5px' border='3px' fontSize='15px' to={`/tags/react`}>react</TopicItem>
                </PopularTag>
                <PopularTag>
                    <TopicItem type='python' size='5px' border='3px' fontSize='15px' to={`/tags/python`}>python</TopicItem>
                </PopularTag>
                <PopularTag>
                    <TopicItem type='git' size='5px' border='3px' fontSize='15px' to={`/tags/git`}>git</TopicItem>
                </PopularTag>
                <PopularTag>
                    <TopicItem type='django' size='5px' border='3px' fontSize='15px' to={`/tags/django`}>django</TopicItem>
                </PopularTag><br></br><br></br>
                <PopularTag>
                    <TopicItem type='css' size='5px' border='3px' fontSize='15px' to={`/tags/css`}>CSS</TopicItem>
                </PopularTag>
                <PopularTag>
                    <TopicItem type='netlify' size='5px' border='3px' fontSize='15px' to={`/tags/netlify`}>Netlify</TopicItem>
                </PopularTag>
            </PopularTagsList>
        </RightSectionWrapper>
    )
